...
def analyze_stock_monthly(stock_name, search_query):
    """단일 종목 월간 심층 분석"""

    user_prompt = f"""다음 종목에 대해 월간 심층 분석을 수행하세요: {stock_name} (검색어: {search_query})

아래 12개 섹션을 모두 포함하여 상세하게 분석하세요. 반드시 최신 데이터를 기반으로 작성하세요.
